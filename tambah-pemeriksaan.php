...
if(!isset($_SESSION['login'])){
    ...
    //membuat id otomatis
    $query = "SELECT max(id_pemeriksaan) as id_pemeriksaan From pemeriksaan";
    $hasil = mysqli_query($conn,$query);
    $data = mysqli_fetch_array($hasil);
    $id_pemeriksaan = $data['id_pemeriksaan'];
    $auto_id = (int) substr($id_pemeriksaan, 3, 5);
    $auto_id++;
    $char = "PMR";
    $id_pemeriksaan = $char.sprintf("%03s",$auto_id);
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="" method="post">
                            <div class="row">
                            <input type="hidden" name="id_pemeriksaan" value="<?php echo $id_pemeriksaan?>" >
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" name="id_obat" required>
                                            <option>Select<option>
                                            <?php
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="kunjungan" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="diagnosa" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
