...
if(!isset($_SESSION['login'])){
    ...
    $mts = tampil("SELECT * FROM obat WHERE id_obat = '$id_obat'")[0];
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="" method="post">
                            <div class="row">
                            <input type="hidden" name="id_obat"  value="<?= $mts['id_obat']; ?>">
                                <div class="col-md-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="nama_obat"  value="<?= $mts['nama_obat']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Jenis Obat <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="jenis_obat"  value="<?= $mts['jenis_obat']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Fungsi <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="fungsi"  value="<?= $mts['fungsi']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Komposisi <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="komposisi"  value="<?= $mts['komposisi']; ?>">
                                    </div>
                                </div>
                            </div>
