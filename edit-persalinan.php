...
if(!isset($_SESSION['login'])){
    ...
    $id_persalinan = $_GET['id_persalinan'];
    $mts = tampil("SELECT * FROM persalinan WHERE id_persalinan = '$id_persalinan'")[0];

    //proses edit data
    if(isset($_POST['simpan'])){
        if( edit_persalinan($_POST) > 0){
            echo "<script>
            setTimeout(function(){
                Swal.fire({
                    icon: 'success',
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="" method="post">
                            <div class="row">
                            <input type="hidden" name="id_persalinan" value="<?= $mts['id_persalinan']; ?>">
                                <div class="col-md-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="date" name="tanggal_persalinan" id="input2" class="form-control" value="<?= $mts['tanggal_persalinan']; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="jenis_persalinan" value="<?= $mts['jenis_persalinan']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Status Lahir <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="status_lahir" value="<?= $mts['status_lahir']; ?>">
                                    </div>
                                </div>
                            </div>
