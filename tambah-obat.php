...
require 'function.php';
    ...
    //membuat id Otomatis
    $query = "SELECT max(id_obat) as id_obat From obat";
    $hasil = mysqli_query($conn,$query);
    $data = mysqli_fetch_array($hasil);
    $id_obat = $data['id_obat'];
    $auto_id = (int) substr($id_obat, 3, 5);
    $auto_id++;
    $char = "OBT";
    $id_obat = $char.sprintf("%03s",$auto_id);
                            ...
                            <input type="hidden" name="id_obat" value="<?php echo $id_obat?>" >
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="fungsi" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Komposisi <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="komposisi" required>
                                    </div>
                                </div>
                            </div>
