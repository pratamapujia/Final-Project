...
$data = tampil("SELECT * FROM pasien ORDER BY id_pasien DESC");
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="tambah-pasien.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Tambah Pasien</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table datatable mb-0">
                                ...
                                <?php foreach ($data as $mts) : ?>
                                    <?php
                                        $tanggal_daftar = date('d-m-Y', strtotime($mts['tanggal_daftar']));
                                    ?>
                                        <tr>
                                            <td><?= $no; ?></td>
                                            <td><?= $mts['id_pasien']; ?></td>
                                            ...
                                            <td><?= $mts['umur']; ?></td>
                                            <td><?= $mts['nama_suami']; ?></td>
                                            <td><?= $mts['pekerjaan']; ?></td>
                                            <td><?= $mts['telepon_pasien']; ?></td>
                                            <td><?= $mts['alamat']; ?></td>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="edit-pasien.php?id_pasien=<?= $mts['id_pasien']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                        <a class="dropdown-item" href="hapus-pasien.php?id_pasien=<?=$mts['id_pasien']; ?>" ><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
