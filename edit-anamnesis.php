...
if(!isset($_SESSION['login'])){
    ...
    $id_anamnesis = $_GET['id_anamnesis'];
    $mts = tampil("SELECT * FROM anamnesis WHERE id_anamnesis = '$id_anamnesis'")[0];

    //proses edit data
    if(isset($_POST['simpan'])){
        if( edit_anamnesis($_POST) > 0){
            echo "<script>
            setTimeout(function(){
                Swal.fire({
                    icon: 'success',
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                <li><a href="anamnesis.php" class="active">Anamnesis</a></li>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Tambah Data Anamnesis</h4>
                    </div>
                </div>
                <header>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="" method="post">
                            <div class="row">
                            <input type="hidden" name="id_anamnesis" value="<?= $mts['id_anamnesis']; ?>">
                                <div class="col-md-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="riwayat_penyakit" value="<?= $mts['riwayat_penyakit']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Jumlah Keguguran <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="jml_keguguran" value="<?= $mts['jml_keguguran']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Cara Persalinan <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="cara_persalinan" value="<?= $mts['cara_persalinan']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Kehamilan Ke <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="kehamilan" value="<?= $mts['kehamilan']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Tekanan Darah <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="tekanan_darah" value="<?= $mts['tekanan_darah']; ?>">
                                    </div>
                                </div>
                            </div>
