...
if(!isset($_SESSION['login'])){
    ...
    $mts = tampil("SELECT * FROM bidan WHERE id_bidan = '$id_bidan'")[0];

    //proses edit data
    if(isset($_POST['simpan'])){
        if( edit_bidan($_POST) > 0){
            echo "<script>
            setTimeout(function(){
                Swal.fire({
                    icon: 'success',
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Edit Bidan</h4>
                    </div>
                </div>
                <header>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row">
                            <input type="hidden" name="id_bidan" value="<?= $mts['id_bidan']; ?>">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_bidan" class="form-control" value="<?= $mts['nama_bidan']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="telepon_bidan" value="<?= $mts['telepon_bidan']; ?>">
                                    </div>
                                </div>
                            </div>
