...
if(!isset($_SESSION['login'])){
    ...
    //memubuat Id otomatis
    $query = "SELECT max(id_pasien) as id_pasien From pasien";
    $hasil = mysqli_query($conn,$query);
    $data = mysqli_fetch_array($hasil);
    $id_pasien = $data['id_pasien'];
    $auto_id = (int) substr($id_pasien, 3, 5);
    $auto_id++;
    $char = "PSN";
    $id_pasien = $char.sprintf("%03s",$auto_id);
                            ...
                            <input type="hidden" name="id_pasien" value="<?php echo $id_pasien?>">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="umur" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Nama Suami <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="nama_suami" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="telepon_pasien" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
